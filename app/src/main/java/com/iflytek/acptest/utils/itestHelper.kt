...
class ItestHelper {
    ...
    fun runServer() {
        ...
        FileHandler.logger("perf","iTest is prepared.")
    }
    ...
    fun startItest() {
        ...
        FileHandler.logger("perf","Launch iTest.")
    }
    ...
    fun monitorStart(vararg args: String, pkg: String) {
        ...
        FileHandler.logger("perf","iTest has started monitoring: $items.")
    }
    ...
    fun monitorFinish() {
        ...
        FileHandler.logger("perf","Finish the iTest monitor.")
    }
